...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: "#f4f4f4", paddingLeft: 20, paddingRight: 20, marginTop: 20, width: "100%" },
    header: { flexDirection: "row", alignItems: "center", paddingBottom: 10, marginTop: 20 },
    backButton: { marginRight: 10 },
    avatar: { width: 40, height: 40, borderRadius: 20, marginRight: 10 },
    headerTitle: { fontSize: 18, fontWeight: "bold" },
    chatList: { flex: 1, marginBottom: 10 },
    messageContainer: { marginBottom: 10, padding: 12, borderRadius: 16, maxWidth: "75%", backgroundColor: "#e6f7ff", alignSelf: "flex-start" },
    ownerMessage: { backgroundColor: "#007bff", alignSelf: "flex-end", borderTopRightRadius: 4 },
    customerMessage: { backgroundColor: "#a9a9a9", alignSelf: "flex-start", borderTopLeftRadius: 4 },
    messageText: { color: "#F8F9FA", fontSize: 16 },
    inputContainer: { flexDirection: "row", alignItems: "center", paddingTop: 5, paddingBottom: 10 },
